...
<select id="dropdown">Sort by...
    <option value="A" data-number="1">Chronologically released</option>
    <option value="B" data-number="2">Most to least likes</option>
    <option value="C" data-number="3">Least to most likes</option>
</select>
